/*
  Warnings:
  - Added the required column `duration` to the `Session` table without a default value.
...
INSERT INTO "new_Client" (
    ...
    "pre_score", "session_day", "session_time", "therapist_id", "updated_at"
)
SELECT
    "address", "dob", "email", "first_name", "hospital_number", "id",
    "is_closed", "last_name", "notes", "outcome", "phone", "post_score",
...
SELECT
    "client_id", "delivery_method", 60, "id", "missed_reason", "notes",
    "occurred_at", "scheduled_at", "session_type", "status", "therapist_id", "updated_at"
FROM "Session";
...
INSERT INTO "new_Therapist" ("first_name", "id", "is_admin", "last_name", "updated_at")
SELECT "first_name", "id", "is_admin", "last_name", "updated_at"
FROM "Therapist";
