  ...
  return (
    <div className="h-full flex flex-col gap-6">
      ...
      <div className="min-h-0 flex-1 overflow-auto">
        <form id="client-form" onSubmit={handleSubmit} className="max-w-2xl space-y-8" noValidate>
      ...
      <div className="max-w-2xl border-t pt-4">
        <div className="flex gap-3">
          <Button type="submit" form="client-form" disabled={formState === FormState.Saving}>
